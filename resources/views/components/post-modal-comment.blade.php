                    ...
                    <form class="main__input--form" wire:submit.prevent="store">
                        <div class="main__form">
                            ...
                            <div class="main__form--container">
                                <textarea class="main__container--input" name="contentComment" id="contentComment" placeholder="{{ __('post.Whats happening?') }}" maxlength="255" wire:model="contentComment" wire:ignore></textarea>
                                @if ($imageComment)
